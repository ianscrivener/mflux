...
Developers can manually run the GitHub Action on their own private GitHub account to push the JSON manifest to a dev directory on HuggingFace - eg [https://huggingface.co/buckets/mflux-community/ci/devs/@ianscrivener/tree/models_mflux.json](https://huggingface.co/buckets/mflux-community/ci/devs/@ianscrivener/tree/models_mflux.json).
